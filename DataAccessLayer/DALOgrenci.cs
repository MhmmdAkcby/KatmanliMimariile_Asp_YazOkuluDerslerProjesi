...
namespace DataAccessLayer
{
    public class DALOgrenci
    {
        ...
        {
            SqlCommand komut1 = new SqlCommand("insert into TBLOGRENCI (OGRAD,OGRSOYAD,OGRNUMRA,OGRFOTO,OGRSIFRE) values (@p1,@p2,@p3,@p4,@p5)", Baglanti.bgl);
        ...
        public static List<EntityOgrenci> OgrenciListesi()
        {
            ...
            while (dr.Read())
            {
                ...
                ent.NUMARA = (dr["OGRNUMRA"].ToString());
        ...
        {
            SqlCommand komut5 = new SqlCommand("Update TBLOGRENCI set OGRAD=@p1, OGRSOYAD=@p2, OGRNUMRA=@p3, OGRFOTO=@p4, OGRSIFRE=@p5 where oGRID=@p6", Baglanti.bgl);
